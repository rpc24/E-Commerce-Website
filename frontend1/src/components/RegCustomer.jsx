                        ...
                        <div className="col-sm-6 mx-auto">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-group form-row">
                                    ...
                                    <div className="col-sm-8">
                                        <input type={showPassword ? "text" : "password"} name="pwd" value={user.pwd} onChange={handleInput} className="form-control" right={<AiOutlineEye/>} />
                                        <AiOutlineEye  onClick={handlePassword}  className={'float-right'}/>
