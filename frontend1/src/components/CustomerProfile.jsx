...
function CustomerProfile(){
    ...
    return (
        <><div className="container " style={{ opacity: '85%' }}>
            <div className="row">
                <div className="col-sm-7 mx-auto">
                    <div className="card shadow  mt-3">
                        <div className="card-body" style={{ backgroundColor: '#99ccff', width: '700px', border: '2px solid black' }}>

                            <h4 className="p-2 text-center" style={{ background: 'linear-gradient(to bottom right, #009999 19%, #ff6666 100%)' }}>Welcome {uname}</h4>
