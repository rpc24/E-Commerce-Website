...
<div className="form-box1">
    <div className="header-form1">
        ...
        <h4 className="text-primary text-center">Customer Login</h4>
    ...
    <div className="body-form">
        <form onSubmit={handleSubmit}>
            ...
            <div className="message">
                ...
                <div><a href="/register">Don't have an acoount?</a></div>
                
            </div>
            <div className="float-right"><a href="/forgotPassword">Forgot Password?</a></div>
        </form>
