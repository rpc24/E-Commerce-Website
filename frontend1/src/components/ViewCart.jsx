            ...
            {state.cart.length > 0 ?
                <div className="row">
                    <div className="col-sm-7">
                        <h4 className="p-2 text-center text-white">Cart View</h4>
                        <table className="table table-bordered table-light table-striped">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>&#8377; {state.cart.reduce((a, b) => (a + b.price * b.qty), 0)}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                    <div className="col-sm-4 bg-white text-black">
                        <form onSubmit={handleSubmit}>
                            <h5 className="p-2 text-white" style={{ background: 'linear-gradient(to bottom right, #009999 19%, #ff6666 100%)' }}>Address Information</h5>
                            ...
                            <h5 className="p-2 text-white" style={{ background: 'linear-gradient(to bottom right, #009999 19%, #ff6666 100%)' }}>Payment Information</h5>
                            <div className="form-group form-row">
                                <label className="col-sm-4 form-control-label">Card No</label>
                                <div className="col-sm-8">
                                    <input type="text" placeholder="xxxx-xxxx-xxxx-xxxx" name="cardno" maxLength ='16' value={payment.cardno} onChange={handlePaymentInput} className="form-control" />
                                </div>
                            </div>
                            <div className="form-group form-row">
                                <label className="col-sm-4 form-control-label">Name on Card</label>
                                <div className="col-sm-8">
                                    <input type="text" placeholder="Name" name="nameoncard" value={payment.nameoncard} onChange={handlePaymentInput} className="form-control" />
                                </div>
                            </div>
                            <div className="form-group form-row">
                            ...
                            <div className="form-group form-row">
                                ...
                                <div className="col-sm-8">
                                    <input type="text" placeholder="" value={payment.cvv} onChange={handlePaymentInput} className="form-control" />
                                </div>
                            </div>
                            <div className="form-group form-row">
                ...
                </div> : <h4 style={{ backgroundcolor: 'black' }}>Cart is Empty</h4>}
        </div><Footer1 /></>
    )
}
